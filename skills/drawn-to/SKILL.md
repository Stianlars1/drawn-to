...
| Receive a generator direction with selected properties | [generator handoff](references/generator-handoff.md) | Resolve exact property contracts, preserve selected roles and clarify consequential gaps |
